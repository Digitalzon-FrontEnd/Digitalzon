...
- 비회원 ➡️ 비회원에게 접근 권한이 있는 기능
- 일반회원 ➡️ 일반회원에게 접근 권한이 있는 기능(설문등록 및 포인트 충전 기능)
- 법인회원 슈퍼관리자 ➡️ 슈퍼관리자에게 접근 권한이 있는 기능(계정관리)
- 디지털존 관리자 ➡️ 디지털존 관리자에게 접근 권한이 있는 기능(통합관리 및 계정관리 기능)
