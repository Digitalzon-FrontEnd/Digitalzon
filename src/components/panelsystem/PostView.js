...
const PostView = ({history, posts, setPosts }) => {
    ...
    let recordTxt = `${date} ${postItem.statemanager} 님이 상태를 ${prevState} 에서 ${selectState} ${ selectState === '처리중' ? '으로' : '로' } 변경하였습니다.`
        ...
        <div className="inner_box">
            <div className="postview-wrap">
                ...
                <div className="postview-btn-box">
                    ...
                    <button className="postview-btn save-btn" onClick={saveBtn}>저장</button>
                    <Link to ="/panel/board">
