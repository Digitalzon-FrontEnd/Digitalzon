...
const PostList = ({posts}) => {
    ...
    const [postsPerPage, setPostsPerPage] = useState(10); //한 페이지에 글 갯수
    ...
    return (
        <div>
            <div className="pannelsystem-content">
                <form className="pannelsystem-form">
                    <div className="pannelsystem-input-box">
                        ...
                        <button className="pannelsystem-input-btn"><img src="/img/mdi-magnify.png" alt="검색버튼" /></button>
                    </div>
                </form>
            </div>
            ...
            <PageList posts={posts} postsPerPage={postsPerPage} totalPosts={posts.length} paginate={setCurrentPage} currentPage={currentPage}/>
        </div>
    );
};
