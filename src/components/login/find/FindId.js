    ...
    <div className="inner">
      ...
      <ul className="findId-form-area">
        <li>
          ...
          <input id="findIdUserEmail" type="text" onKeyUp={emailcheck} autoFocus/>
          <p className="warn"><span id="findIdNoAt" className="trans">잘못된 메일형식입니다.</span></p>
        </li>
        <li>
      ...
      <div className="findId-btn-box">
        ...
        <button className="findId-btn-cancel btn-r btn-g"><Link to="/">취소</Link></button>
      </div>
    </div>
  );
};
