    ...
    <div className="inner">
      ...
      <ul className="findPw-form-area">
        <li>
          ...
          <input id="findPwUserEmail" type="text" onKeyUp={emailcheck} autoFocus/>
          <p className="warn"><span id="findPwNoAt" className="trans">잘못된 메일형식입니다.</span></p>
        </li>
        <li>
        ...
        <li>
          ...
          <div className="findPw-cellNum-box">
            <input id="findPwCellNum1" type="text" maxLength="3" onKeyUp={lengthcheck}/>
            <input id="findPwCellNum2" type="text" maxLength="4" onKeyUp={lengthcheck}/>
            <input id="findPwCellNum3" type="text" maxLength="4" />
            <button className="findPw-btn-send-certifyNum btn-s btn-o">인증번호 발송</button>
          </div>
        </li>
        <li>
      ...
      <div className="findPw-btn-box">
        <button className="findPw-btn-id-send btn-r btn-o">임시 비밀번호 발송</button>
        <button className="findPw-btn-cancel btn-r btn-g"><Link to="/">취소</Link></button>
      </div>
    </div>
  );
};
